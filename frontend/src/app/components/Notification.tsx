  ...
  const notifications = [
    {
      ...
      message: '국세청에서 받은 메세지에서 피싱 위험이 감지되었습니다.',
      time: '5분 전',
      isRead: false,
    },
    {
      id: 2,
      title: '⚠️ 스미싱 위험 메세지 탐지',
      message: '010-1234-5678에서 받은 메세지가 의심스럽습니다.',
      time: '1시간 전',
      isRead: false,
    },
    {
      id: 3,
      title: '⚠️ 스미싱 위험 메일 탐지',
      message: '애플리에서 받은 메일에 피싱 링크가 포함되어 있습니다.',
      time: '3시간 전',
      isRead: false,
    },
    {
      id: 4,
      title: '⚠️ 스미싱 위험 메세지 탐지',
      message: '경찰청을 사칭한 문자가 탐지되었습니다.',
      time: '1일 전',
      isRead: true,
    },
    {
      id: 5,
      title: '⚠️ 스미싱 위험 전화번호 탐지',
      message: '010-9876-5432는 스팸 신고 내역이 있는 번호입니다.',
      time: '2일 전',
      isRead: true,
    },
  ];
